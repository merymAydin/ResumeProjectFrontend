            ...
            <div className="resume-section-content">
              <h2 className="mb-5">Experiences</h2>
              {
                ...
                <div className="flex-shrink-0">
                  <span className="text-primary">{new Date(experience?.startDate).toLocaleDateString()} - {experience?.endDate ? new Date(experience?.endDate).toLocaleDateString() : 'Present'}</span>
                </div>
              </div>)
              }
